...
- **⑤設計案+回収率実測=docs/data-quality/DESIGN_tier2-05_相手未解決一括再解決_2026-07-04.md(承認待ち・実装未着手)**: 階層実測 T1=178/T2=2,628(82%が中学生選手権系9大会)/T3姓前方一致=5,595(誤結線サンプル0)/T4括弧頭文字=212/amb系1,348。**一次回収8,613件=57.6%**(→残6,331)・理論上限66.7%。t1459除外・t833名簿欠落583とN0 1,795は対象外。未決3点=T3往復照合の必須性/materialize Pass2へのT2追加PR/二次回収の同時適用
