...
describe('ファイル名（R9）', () => {
  ...
  it('年をまたぐと年から書く（Codex R1 #11）', () => {
    expect(formatDateRun(['2026-12-31', '2027-01-01'])).toBe('2026.12.31,2027.1.1')
  })

  it('異なる年の同じ月でも年から書く（月だけでは表せない。Codex R1 #11）', () => {
    expect(formatDateRun(['2026-06-13', '2027-06-13'])).toBe('2026.6.13,2027.6.13')
  })
