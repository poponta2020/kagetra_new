...
- `tournament-results` — 大会結果の取込・承認・materializeとパーサ基盤（主要領域: apps/web, apps/mail-worker, packages/shared） [shipped: PR #541] / 2026-09-13 改修: 受信箱で「取込中は消す → 承認待ちで復活」・未処理件数の述語統一・「対応不要」ガード拡張
